...
import { trackBooking, trackCall, trackWhatsapp } from "@/lib/gtag";
      ...
      <div className="space-y-3">
        <div className="grid grid-cols-2 gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            onClick={() => trackWhatsapp("mobile_whatsapp_bar")}
        ...
        <Link
          ...
          className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-full border border-slate-300 bg-white px-4 text-sm font-medium text-slate-900 transition hover:bg-slate-50"
        >
