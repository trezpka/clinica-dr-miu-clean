      ...
      <section className="relative overflow-hidden border-b border-slate-100">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-slate-950 md:text-6xl">Contact Clinica Dr. Miu</h1>
            <p className="mt-6 text-lg leading-8 text-slate-600">
              Dacă ai nevoie de o evaluare pentru implant dentar în Buzău, tratamente de implantologie sau chirurgie dento-alveolară, ne poți contacta pentru programare.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          <Card className="rounded-[2rem] border-slate-200 bg-slate-950 text-white shadow-xl">
            <CardContent className="p-8 md:p-10 space-y-5 text-sm">
          ...
          <Card className="rounded-[2rem] border-slate-200 shadow-sm">
            <CardContent className="p-8 md:p-10">
              <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Programare rapidă</h2>
              <p className="mt-3 text-sm leading-7 text-slate-600">Formular gata pentru conectare la email, CRM sau WhatsApp.</p>
              <ContactForm />
            </CardContent>
          </Card>
        </div>
